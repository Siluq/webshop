...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 23 apr 2020 om 14:55
...
CREATE TABLE `customer` (
  ...
  `klanten_password` varchar(255) NOT NULL,
...
INSERT INTO `customer` (`id`, `gender`, `firstName`, `middleName`, `lastName`, `street`, `houseNumber`, `houseNumber_addon`, `zipCode`, `city`, `phone`, `email`, `klanten_password`, `newsletter_subscription`) VALUES
...
(2, 'Muurlamp', 'Deze buitenlamp is pervect voor bij uw voordeur.\r\n<br><br>\r\nLichtbron wordt apart verkocht. IKEA adviseert de led-lamp E27 globevorm opaalwit.\r\n<br><b>\r\nGebruik een opalen lichtbron als je een gewone lampenkap of lamp hebt en je een gelijkmatig', 2, '49.95', 'zwart', '950', 1),
...
INSERT INTO `user` (`id`, `firstName`, `middleName`, `lastName`, `email`, `user_password`) VALUES
(2, 'Thomas', 'Tinus', 'Tijs', 'tthijs@glu.nl', '12345'),
(11, 'Sam', '', 'Boesjes', 'Sam.boesjes@gmail.com', '$2y$08$0Bvi8b73nVeOMhNyndmjTuo4BW82PGxCfDJGdw2dgpazktj3oXS22'),
(12, 'Mark', '', 'fredriksz', 'Mark.frediksz@gmail.com', '$2y$08$i8ac8nPmy8ma87ck3hQHBuE3kBOLWrGkNNIfT0WJDJF6ooXvSit6W');
